...
def get_authorization_url() -> tuple:
    ...
    # flow.code_verifier is auto-generated by google-auth-oauthlib for PKCE.
    # It must be carried forward to the callback step, since a fresh Flow()
    # object is built there and won't have it otherwise.
